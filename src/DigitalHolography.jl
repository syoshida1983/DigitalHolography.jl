...
function ParallelPSDH(I)
    ...
    v₁ = @. (I₁₁ + I₁₂ + I₁₃ + I₁₄)/4
    w₁ = @. √((I₁₁ - I₁₃)^2 + (I₁₂- I₁₄)^2)/2
    u[1:2:Ny, 1:2:Nx] = @. √((v₁ - √(v₁^2 - w₁^2 + 0im))/2)*exp(im*ϕ₁)
    ...
    v₂ = @. (I₂₁ + I₂₂ + I₂₃ + I₂₄)/4
    w₂ = @. √((I₂₁ - I₂₃)^2 + (I₂₂ - I₂₄)^2)/2
    u[1:2:Ny, 2:2:Nx-1] = @. √((v₂ - √(v₂^2 - w₂^2 + 0im))/2)*exp(im*ϕ₂)
    ...
    v₃ = @. (I₃₁ + I₃₂ + I₃₃ + I₃₄)/4
    w₃ = @. √((I₃₁ - I₃₃)^2 + (I₃₂ - I₃₄)^2)/2
    u[2:2:Ny-1, 1:2:Nx] = @. √((v₃ - √(v₃^2 - w₃^2 + 0im))/2)*exp(im*ϕ₃)

    I₄₁ = I[3:2:Ny, 2:2:Nx-1]
    I₄₂ = I[3:2:Ny, 3:2:Nx]
    I₄₃ = I[2:2:Ny-1, 3:2:Nx]
    I₄₄ = I[2:2:Ny-1, 2:2:Nx-1]
    ϕ₄ = @. atan(I₄₂ - I₄₄, I₄₁ - I₄₃)
    v₄ = @. (I₄₁ + I₄₂ + I₄₃ + I₄₄)/4
    w₄ = @. √((I₄₁ - I₄₃)^2 + (I₄₂ - I₄₄)^2)/2
    u[2:2:Ny-1, 2:2:Nx-1] = @. √((v₄ - √(v₄^2 - w₄^2 + 0im))/2)*exp(im*ϕ₄)
